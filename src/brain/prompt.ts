...
function menuSection(catalogText?: string): string[] {
  ...
  return [
    ...
    "k. PREFERENCES. When the guest states a preference for a service (a male or female therapist, an allergy, a quiet table, extra pillows), put it word for word in that request detail so the team sees it, and tell the guest you have passed it to the team, who will confirm. Never confirm a preference yourself.",
  ];
}
